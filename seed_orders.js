...
const Order = require('./backend/db/Order');
const Trip = require('./backend/db/Trip');
const Truck = require('./backend/db/Truck');
const OwnerOperator = require('./backend/db/OwnerOperator');
const DriverProfile = require('./backend/db/DriverProfile');
const Company = require('./backend/db/Company');
const OwnerOperatorFinancialRecord = require('./backend/db/OwnerOperatorFinancialRecord');
...
async function seed() {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    const owner = owners.find(o => String(o._id) === String(truck.ownerOperator)) || getRandom(owners);
